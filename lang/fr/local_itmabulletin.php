...
$string['choose_student'] = 'Choisir un étudiant';
$string['choose_semester'] = 'Choisir un semestre';
$string['generate'] = 'Afficher le bulletin';
$string['downloadpdf'] = 'Télécharger en PDF';

$string['nostructure'] = 'Aucune UE / EC trouvée pour ce semestre.';
$string['nonotes'] = 'Aucune note trouvée pour ce semestre.';
$string['bulletin_for'] = 'Bulletin de notes';
$string['semester_label'] = 'Semestre : {$a}';
$string['date_of_birth'] = 'Date de naissance';
$string['place_of_birth'] = 'Lieu de naissance';
$string['nationality'] = 'Nationalité';
$string['student_id'] = 'Matricule';
$string['major'] = 'Filière / Spécialité';

$string['credits'] = 'Crédits';
$string['classmark'] = 'Note de classe';
$string['exammark'] = 'Note d\'examen';
$string['makeupmark'] = 'Note de rattrapage';
$string['average'] = 'Moyenne';
$string['sessiondate'] = 'Date de session';

$string['ue'] = 'Unité d\'enseignement (UE)';
$string['ec'] = 'Éléments constitutifs (EC)';
$string['general_average'] = 'Moyenne générale du semestre';
$string['total_credits'] = 'Total de crédits validés';
